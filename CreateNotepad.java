...
public class CreateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://180.76.151.46/LinuxExam";
    final static String USER = "root";
    final static String PASS = "Jss728@!";
    final static String SQL_INSERT_NOTEPAD = "INSERT INTO notepad(id,noteName,noteTime) VALUES (?,?, ?)";
    ...
    private int createNotepad(Notepad req) {
        ...
        try {
            ...
            stmt.setString(2, req.noteName);
            stmt.setString(3, req.noteTime);
